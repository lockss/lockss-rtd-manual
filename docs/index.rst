.. image:: /images/lockss-2.0-alpha3_200.png
   :alt: LOCKSS 2.0-alpha3 logo
   :align: right
...
If you were running LOCKSS 2.0-alpha2, you no longer need Docker [#fn1]_nor Java 8 installed on the host machine.

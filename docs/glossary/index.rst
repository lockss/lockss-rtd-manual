...
.. glossary::
   ...
   firewalld
      ...
      Firewalld is developed by `Canonical <https://canonical.com/>`_.
   ...
   LOCKSS stack
      The LOCKSS stack is the :term:`container stack <stack>` providing the functionality of the LOCKSS system as a whole.

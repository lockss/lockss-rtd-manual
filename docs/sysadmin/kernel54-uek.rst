...
If an upgrade to Linux kernel 5.4 or later is required for this operating system, you will need to install the `Unbreakable Enterprise Kernel Release 6 Update 3 <https://docs.oracle.com/en/operating-systems/uek/6/relnotes6.3/index.html>`_ (UEK R6U3) from the `Unbreakable Linux Network <https://linux.oracle.com/>`_ (ULN). Follow these steps:

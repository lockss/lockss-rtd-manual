...
.. tip::
   ...
   If you are upgrading an existing LOCKSS 2.0 system to LOCKSS |LATEST_PATCH|, please see the upgrade instructions in the previous chapter (:doc:`/upgrading/index`) instead.

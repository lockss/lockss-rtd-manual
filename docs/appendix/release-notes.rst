...
------------------------------------
LOCKSS 2.0.90-beta2 NOT YET RELEASED
------------------------------------

Released: NOT YET RELEASED

LOCKSS 2.0.90-beta2 NOT YET RELEASED is the second beta release of the LOCKSS 2.0 system.
...
LOCKSS 2.0.90-beta2 NOT YET RELEASED consists of a configurable set of the following components:

*  `LOCKSS Installer <https://github.com/lockss/lockss-installer>`_ version 2.0.90-beta2 NOT YET RELEASED
